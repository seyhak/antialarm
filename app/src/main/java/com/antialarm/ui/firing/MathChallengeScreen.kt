...
@Composable
fun MathChallengeScreen(difficulty: Int, onSolved: () -> Unit, onCancel: () -> Unit) {
        ...
        Box(
                ...
                Column(
                        ...
                        OutlinedTextField(
                                ...
                                colors =
                                        OutlinedTextFieldDefaults.colors(
                                                focusedBorderColor =
                                                        if (showError) AccentRed
                                                        else MaterialTheme.colorScheme.primary,
                                                unfocusedBorderColor =
                                                        if (showError) AccentRed else DarkCard,
                        ...
                        TextButton(onClick = onCancel) {
                                Text("← Back to alarm", color = TextMuted)
                        }
                }
        }
}
